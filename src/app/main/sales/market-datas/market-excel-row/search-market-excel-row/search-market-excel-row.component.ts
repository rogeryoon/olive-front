...
@Component({
  selector: 'olive-search-market-excel-row',
  templateUrl: './search-market-excel-row.component.html',
  styleUrls: ['./search-market-excel-row.component.scss']
})
export class OliveSearchMarketExcelRowComponent implements OnInit, OliveOnSearch {
  data: any;
