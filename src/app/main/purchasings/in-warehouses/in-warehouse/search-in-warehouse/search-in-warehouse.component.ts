...
@Component({
  ...
  templateUrl: './search-in-warehouse.component.html',
  styleUrls: ['./search-in-warehouse.component.scss']
})
export class OliveSearchInWarehouseComponent implements OnInit, OliveOnSearch {
  data: any;
