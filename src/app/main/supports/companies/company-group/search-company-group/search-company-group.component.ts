...
@Component({
  selector: 'olive-search-company-group',
  templateUrl: './search-company-group.component.html',
  styleUrls: ['./search-company-group.component.scss']
})
export class OliveSearchCompanyGroupComponent implements OnInit, OliveOnSearch {
  data: any;
