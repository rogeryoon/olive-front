...
@Component({
  selector: 'olive-search-carrier-tracking-number-range',
  templateUrl: './search-carrier-tracking-number-range.component.html',
  styleUrls: ['./search-carrier-tracking-number-range.component.scss']
})
export class OliveSearchCarrierTrackingNumberRangeComponent implements OnInit, OliveOnSearch {
  data: any;
