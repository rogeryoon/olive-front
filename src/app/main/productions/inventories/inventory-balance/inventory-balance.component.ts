...
@Component({
  selector: 'olive-inventory-balance',
  templateUrl: './inventory-balance.component.html',
  styleUrls: ['./inventory-balance.component.scss'],
  animations: fuseAnimations
})
export class OliveInventoryBalanceComponent implements AfterViewInit, OnDestroy, OnInit {
